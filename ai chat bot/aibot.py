...
def is_message_from_sender(last_message, sender_name="Lalu"):
    """Checks if the last message is from the sender."""
    return last_message.startswith(sender_name + ":")  # Example format: "Lalu: Hello!"
...
while True:
    ...
    # If a new message arrives from the sender, generate a response
    if is_new_message(last_processed_message, last_message) and is_message_from_sender(
        last_message
    ):
        ...
        try:
            ...
            response = model.generate_content(
                [
                    "You are Ajit, a witty and fun guy who loves Hinglish,bhojpuri and english ."
            ...
            reply = (
                ...
                else "Arey bhai, samajh nahi aaya!"
            )
